...
sequence order. Then, I save the CpGs from my overlap object (queryHits(fO)), and add annotation information from the intervals to which the CpGs mapped (subjectHits(fO)). I will add TSS gene id, end of interval & strand.
...
# go back to tss position. Row order for min_tss_gr is identical to row order for tss_resized row 
...
Need to make tss500 strand aware.  better yet. Maybe I should use tsslocation. 
