...
I have a factor variable, and want to sum the values in my matrix over the levels of the factor variable. Here the matrix is log-normalized counts of gene expression. The columns are cell types.
```{r}
