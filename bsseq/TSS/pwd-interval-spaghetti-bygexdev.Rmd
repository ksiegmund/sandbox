...
The question I want to address is how to smooth DNAm estimates across the interval.
Darryl had Caihong bin the chromosomes by 100 bps, and compute pooled M/(M+U). This is
a good way to smooth when the correlation within bins is small. Then the average beta across bins was computed.  Can we do better?

I wanted to explore this by plotting some example profiles. We can look at TSS regions (currently width 3001bps) outside CpG islands.

Refer to dnam-interval-spaghetti-byexpdev.Rmd to draw figures.

# Plot paired-sample DNAm by site across intervals
