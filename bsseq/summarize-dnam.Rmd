...
#betajn <- import(file.path(readdir,"wg_s4c.bed"), format = "BED")
```
need to skip line 1 in the above .bed file.
...
Let's read so it's not a Genomic ranges. Go find code from PM566.
```{r beta-n2}
library(data.table)
